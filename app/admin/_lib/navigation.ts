export const adminNavigation = [
  { href: "/admin", label: "Dashboard", countLabel: "home" },
  { href: "/admin/site-settings", label: "Pengaturan Web", countLabel: "site" },
  { href: "/admin/seo", label: "SEO", countLabel: "seo" },
  { href: "/admin/hero", label: "Hero", countLabel: "hero" },
  { href: "/admin/biography", label: "Biografi", countLabel: "bio" },
  { href: "/admin/services", label: "Layanan", countLabel: "svc" },
